                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <select name="acct_type"
                                                                                class="form-control  basic" required>
                                                                            <option
                                                                                value="<?= $row['acct_type'] ?>"><?= $row['acct_type'] ?></option>
                                                                            ...
                                                                            <option value="Fixed Deposit">Fixed
                                                                                Deposit
                                                                            </option>
                                                                            <option value="Non Resident">Non Resident
                                                                                Account
                                                                            </option>
                                                                            <option value="Online Banking">Online
                                                                                Banking
                                                                            </option>
                                                                            <option value="Domicilary Account">
                                                                                Domicilary Account
                                                                            </option>
                                                                            <option value="Joint Account">Joint
                                                                                Account
                                                                            </option>
                                                                        </select>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="date" class="form-control mb-4"
                                                                           id="profession" placeholder="Date Of Birth"
                                                                           value="<?= $row['acct_dob'] ?>"
                                                                           name="acct_dob">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4"
                                                                           ...
                                                                           value="<?= $row['acct_occupation'] ?>"
                                                                           name="acct_occupation">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control mb-4"
                                                                           ...
                                                                           value="<?= $row['limit_remain'] ?>"
                                                                           name="acct_transfer_limit">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select name="acct_gender"
                                                                            class="form-control  basic" id="">
                                                                        <option
                                                                            value="<?= $row['acct_gender'] ?>"><?= $row['acct_gender'] ?></option>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text"
                                                                           ...
                                                                           id="profession" placeholder="Marital Status"
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        ...
                                                                        <button
                                                                            class="btn btn-danger disabled col-md-12"><?= $row['acct_balance'] ?></button>
                                                                    </div>
                                                                    <div class="col-md-8">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" class="form-control mb-4"
                                                                                   name="acct_limit"
                                                                                   placeholder="<?= $row['acct_limit'] ?>"
                                                                                   value="<?= $row['acct_limit'] ?>">

                                                                            <input type="text" name="acct_balance"
                                                                                   hidden
                                                                                   value="<?= $row['acct_balance'] ?>">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mx-auto">
                                            ...
                                            <div class="form-group">
                                                <button class="btn btn-danger mb-4 disabled">CURRENT STATUS:
                                                    <b><?= ucwords($row['acct_status']) ?></b></button>
                                                <br>
                                        ...
                                        <div class="col-md-4 mx-auto">
                                            ...
                                            <div class=" text-center">
                                                <button class="btn btn-primary" name="billing_code">Change Billing
                                                    Code
                                                </button>
                                            </div>
                                        </div>
                                ...
                                <div class="info">
                                    ...
                                    <div class="row">
                                        <div class="col-md-11 mx-auto">
                                            ...
                                            <div class="form-group">
                                                <button class="btn btn-primary" name="change_password">Change Password
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <form class="section about" method="post" autocomplete="off" autofocus="off">
                                <div class="info">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a class="btn btn-danger text-center col-md-12 disabled ">Current Pin
                                                : <?= $row['acct_pin'] ?></a>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-11 mx-auto">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <form class="section about" method="POST">
                                                    ...
                                                    <button class="btn btn-danger" name="status_delete"> Delete User
                                                    </button>
